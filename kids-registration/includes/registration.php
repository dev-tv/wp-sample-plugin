...
<!--        <input type="hidden" name="amount" value=""/>-->
        ...
        <input type="hidden" name="cancel_url" value="<?php echo site_url(); ?>/kidsinfo/"/>
        <!--<input type="hidden" name="language" value=""/>-->
        <div class="row">            
            <div class="col-md-12">
                <div class="form-field">
                    <label>Child's Name<em>*</em></label>
                    <input type="text" name="child_name" class="form-input form-control" pattern="[a-z A-Z]{1,40}$" required title="Child Name Should be Alphabets and not greater than 40 characters" />
                </div>
            </div> 
            <div class="col-md-6">
                <div class="form-field">
                    <label>Date Of Birth<em>*</em></label>
                    <input type="text" class="form-input form-control" name="date_of_birth" id="datepicker" required onchange="count_age(this.value)" placeholder="DD-MM-YYYY" pattern="(0?[1-9]|[12][0-9]|3[01])[\/\-](0?[1-9]|1[012])[\/\-]\d{4}$"  title="Date Must Be In DD-MM-YYYY"> 
                </div>
            </div> 
            <div class="col-md-6">
                <div class="form-field">
                    <label>Child's Age<em>*</em></label>
                    <input type="text" name="age" class="form-input form-control" id="age" readonly>
                </div>
            </div> 
            <div class="col-md-12">
                <div class="form-field">
            ...
            <div class="col-md-6">
                <div class="form-field">
                    ...
                    <input type="text" name="parent_name" class="form-input form-control" pattern="[a-z A-Z]{1,40}$" required title="Parent Name Should be Alphabets and not greater than 40 characters" />
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-field">
                    <label>Contact Number<em>*</em></label>
                    <input type="text" name="contact_number" class="form-input form-control" pattern="[7-9]{1}[0-9]{9}"  required />
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-field">
                    <label>Parent's Email Id<em>*</em></label>
                    <input type="email" name="email_id" class="form-input form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required />
                </div>
            </div>            
            <div class="col-md-6">
                <div class="form-field">
                    <label>Facebook Address</label>
                    <input type="text" name="facebook_id" class="form-input form-control" />
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-field">
                    <label>Address<em>*</em></label>
                    <textarea name="address" class="form-input form-control"  required></textarea>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-field">
            ...
            <div class="col-md-6">
                <div class="form-field">
                    ...
                    <input type="text" name="city" class="form-input form-control" required />
                </div>
            </div>             
            <div class="col-md-4"> 
            ...
            <div class="col-md-12"> 
                <div class="form-field photo">
                    ...
                    <div>
                        <p>*Registration Fees : INR 950.00 /-</p>
                    </div>
                </div>
            </div>
            <div class="col-md-12"> 
