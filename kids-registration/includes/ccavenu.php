...
class Payment_Adapter_Ccavenue extends Payment_AdapterAbstract
{
    ...
    public function singlePayment(Payment_Invoice $invoice)
    {
        ...
        $Amount         = '254';
        $Order_Id       = '546';
        $Redirect_Url   = 'http://solutionsofts.com/cute-kids/registration/';
        ...
        $data['TxnType']        = 'A';
        $data['ActionID']       = 'TXN';
        $data['billing_cust_name']      = 'David';
        $data['billing_cust_address']   = 'Indore';
        $data['billing_cust_country']   = 'India';
        $data['billing_cust_state']     = 'M.P';
        $data['billing_cust_city']      = 'Indore';
        $data['billing_zip']            = '452010';
        $data['billing_zip_code']       = '452010';
        $data['billing_cust_tel']       = '4578958458';
        $data['billing_cust_email']     = 'vyadav@laxyosolutionsoft.com';
        $data['delivery_cust_name']     = 'David';
        $data['delivery_cust_address']  = 'Indore';
        $data['delivery_cust_city']     = 'Indore';
        $data['delivery_cust_country']  = 'India';
        $data['delivery_cust_state']    = 'M.P';
        $data['delivery_cust_tel']      = '5487598542';
